...
5 tools dispatch to. See shared/app.py's SYSTEM_INSTRUCTIONS (the actual text
served to a connecting MCP client as its `instructions`) for the full, current
...
from entities.lead import (
    ...
    search_idle_leads_logic,
)
from entities.contact import (
    _fetch_contact_fields,
    get_contact_field_instructions_logic,
    create_contact_logic,
    update_contact_logic,
    get_contact_logic,
    search_contacts_logic,
    search_contacts_by_term_logic,
)
from entities.task import (
    TASK_PICKLIST_FIELDS_USE_INTERNAL_NAME,
    _fetch_task_fields,
    get_task_field_instructions_logic,
    create_task_logic,
    update_task_logic,
    get_task_logic,
    search_tasks_logic,
    search_tasks_by_term_logic,
    lookup_entity_for_task,
    search_tasks_with_any_relation,
)
from entities.deal import (
    DEAL_PICKLIST_FIELDS_USE_INTERNAL_NAME,
    _is_stage_lock_error,
    _advance_deal_to_stage_sequentially,
    _fetch_deal_fields,
    get_deal_field_instructions_logic,
    _build_deal_search_json_rule,
    _normalize_deal_payload,
    create_deal_logic,
    update_deal_logic,
    get_deal_logic,
    search_deals_logic,
    search_deals_by_term_logic,
    search_idle_deals_logic,
)
from entities.company import (
    COMPANY_PICKLIST_FIELDS_USE_INTERNAL_NAME,
    _fetch_company_fields,
    get_company_field_instructions_logic,
    _build_company_search_json_rule,
    create_company_logic,
    update_company_logic,
    get_company_logic,
    search_companies_logic,
    search_companies_by_term_logic,
    search_idle_companies_logic,
)
from entities.meeting import (
    MEETING_PICKLIST_FIELDS_USE_INTERNAL_NAME,
    _fetch_meeting_fields,
    get_meeting_field_instructions_logic,
    _build_meeting_search_json_rule,
    create_meeting_logic,
    update_meeting_logic,
    get_meeting_logic,
    _normalize_meeting_sort,
    search_meetings_logic,
    search_meetings_by_term_logic,
    lookup_meeting_related_entity,
)
from entities.call_log import (
    CALL_LOG_PICKLIST_FIELDS_USE_INTERNAL_NAME,
    _fetch_call_log_fields,
    get_call_log_field_instructions_logic,
    create_call_log_logic,
    update_call_log_logic,
    _build_call_log_search_json_rule,
    search_call_logs_logic,
    get_call_logs,
)
from entities.quotation import (
    _fetch_quotation_fields,
...
# ---------------------------------------------------------------------------
# Standalone Tool: Get Entity Labels (call FIRST, alongside get_current_user)
# ---------------------------------------------------------------------------
